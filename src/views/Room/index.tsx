    ...
    try {
      ...
      if (data.messageId)
        setRoom({
          ...
          questions: [
            ...(room.questions || []),
            { ...messageBody, upVotes: 0, id: data.messageId },
          ],
        });
    } catch (err) {
      console.log(err);
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div>
              {user ? (
                ...
                <span>
                  Para enviar uma pergunta, <button onClick={() => login()}>faça seu login</button>
                </span>
              )}
              <Button
                $type="primary"
          ...
          <EmptyQuestions>
            ...
            <span>
              {isAdmin
                ...
                : `${
                    !user ? 'Faça o seu login e s' : 'S'
                  }eja a primeira pessoa a fazer uma pergunta!`}
            </span>
          </EmptyQuestions>
        )}
      </Content>
